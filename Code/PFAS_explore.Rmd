...
# how many samples of analytes

ggplot(PFAS_WWTP_clean, aes(x = Analyte)) +
  geom_bar(data = PFAS_WWTP_clean %>% filter(ppt != "NA")) +
...
### Source 
ggplot(subset(PFAS_Source_clean, Analyte %in% c("PFOA", "PFOS", "PFBA", "PFHxA", "PFHpA", "PFPeA"))) +
  geom_freqpoly(aes(x = ppt, color = Analyte), bins = 50) +
  scale_x_continuous(limits = c(0, 250)) +
  theme(legend.position = "top") +
  labs(x = "PPT", y = "Number of Samples") +
  ggtitle("Number of Analyte Samples by Level at Source Sites")
