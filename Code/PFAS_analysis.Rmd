...
getwd()
setwd("Z:/ENV872/Environmental_Data_Analytics_2021/Project/EDAFinal_PFAS")
...
summary(source_ND_under30)
summary(source_ND_above30)

ggplot(source_ND_under30)+
  geom_histogram(aes(x=limit))+
  xlab("ND under 30 ppt")+
  ylab("# of Samples")

ggplot(source_ND_above30)+
  geom_histogram(aes(x=limit), binwidth = 0.4)+
  xlab("ND above 30 ppt")+
  ylab("# of Samples")
```
